...
class PPO():
    ...
    def update(self, replay_buffer, total_steps):
        ...
        for _ in range(self.K_epochs):
            # Random sampling and no repetition. 'False' indicates that training will continue even
            # if the number of samples in the last time is less than mini_batch_size
